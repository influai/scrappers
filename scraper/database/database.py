...
class Peers(Base):
    """
    Stores data about channel peer (id, access_hash) with corresponding scraper_id.
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True)
    scraper_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
    channel_name: Mapped[str] = mapped_column(String, nullable=False)
    channel_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
    access_hash: Mapped[int] = mapped_column(BigInteger, nullable=False)

    def __repr__(self) -> str:
        return f"Peers(id={self.id!r}, scraper_id={self.scraper_id!r}), channel_id={self.channel_id!r}"
